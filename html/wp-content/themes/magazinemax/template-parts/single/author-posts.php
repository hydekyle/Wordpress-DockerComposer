...
$author_posts_text = magazinemax_get_option('author_posts_text');
$no_of_author_posts = absint(magazinemax_get_option('no_of_author_posts'));
$order = esc_attr(magazinemax_get_option('author_posts_order'));
$orderby = esc_attr(magazinemax_get_option('author_posts_orderby'));
