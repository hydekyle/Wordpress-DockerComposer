 ...
 * @package Magazinemax
 */
$ed_header_ad = magazinemax_get_option('ed_header_ad');
$ed_header_type = magazinemax_get_option('ed_header_type');
$upload_add_image = magazinemax_get_option('upload_add_image');
$ed_header_link = magazinemax_get_option('ed_header_link');
$advertisement_section_title = magazinemax_get_option('advertisement_section_title');
        ...
        <div class="<?php echo esc_attr($ed_header_type); ?>">
                ...
                <header class="welcome-screen-header">
                    ...
                    <div class="welcome-screen-actions">
                        ...
                        <button type="button" class="welcome-screen-skip">
                            <?php echo esc_html__('Skip This', 'magazinemax') ?>
                        </button>
                    </div>
                </header>
            <?php } ?>
            ...
            <?php if ($upload_add_image) { ?>
                ...
                <a href="<?php echo esc_url($ed_header_link); ?>" class="welcome-screen-image" target="_blank">
                    <img src="<?php echo esc_url($upload_add_image); ?>" alt="<?php echo esc_attr($image_alt_text); ?>"
                         title="<?php echo esc_attr($image_alt_text); ?>"/>
                </a>
            <?php } ?>
