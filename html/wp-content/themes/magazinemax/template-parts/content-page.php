...
if (empty($magazinemax_page_layout)) {
    $magazinemax_page_layout = 'layout-1';
}
?>

<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <?php if ($magazinemax_page_layout == "layout-1") { ?>
    ...
    <div class="entry-content">
        ...
        wp_link_pages(
            array(
                'before' => '<div class="page-links">' . esc_html__('Pages:', 'magazinemax'),
                'after' => '</div>',
            )
        );
        ?>
