<div class="magazinemax-nav-pagination">
    <?php
    ...
    if ('ajax_load_on_click' == $pagination_type || 'ajax_load_on_scroll' == $pagination_type):
        ...
        magazinemax_ajax_pagination($pagination_type);
    ...
    elseif ('numeric' == $pagination_type):
        ...
        $prev_text = sprintf(
            ...
            __('Older Posts', 'magazinemax')
        );
        $next_text = sprintf(
            '%s <span class="nav-next-text title">%s</span>',
            '<span class="arrow" aria-hidden="true">&rarr;</span>',
            __('Newer Posts', 'magazinemax')
        );
