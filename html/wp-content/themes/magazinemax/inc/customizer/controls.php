 ...
 */
class Magazinemax_Dropdown_Taxonomies_Control extends WP_Customize_Control
{
    ...
    public function render_content()
    {
        ...
        <label>
            ...
            $dropdown_args = wp_parse_args($this->dropdown_args, array(
                ...
                'show_option_none' => __('&mdash; Select &mdash;', 'magazinemax'),
                'selected' => $this->value(),
                'show_option_all' => '',
                'orderby' => 'id',
                'order' => 'ASC',
 ...
 * @see WP_Customize_Control
 */
class Magazinemax_Radio_Image_Control extends WP_Customize_Control
{
        ...
        <div id="input_<?php echo esc_attr($this->id); ?>" class="radio-image">
            <?php foreach ($this->choices as $value => $option) : ?>
                ...
                <label for="<?php echo esc_attr($this->id) . esc_attr($value); ?>">
                    <img src="<?php echo esc_html($option['url']); ?>" alt="<?php echo esc_attr($option['label']); ?>"
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Magazinemax_Custom_Radio_Image_Control extends WP_Customize_Control {

        public $type = 'magazinemax-radio-image';
        ...
        public function render_content() {
            ...
            <div id="input_<?php echo esc_attr($this->id); ?>" class="image magazinemax-radio-image-buttenset">
...
class Magazinemax_Checkbox_Multiple extends WP_Customize_Control
{
...
if (class_exists('WP_Customize_Control')) {
    ...
    // Repeator Info
    class Magazinemax_Seperator_Control extends WP_Customize_Control
    {
...
if (class_exists('WP_Customize_Control')) {
    ...
    // Repeator Info
    class Magazinemax_Premium_Notice_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            <span class="customize-control-title">
                <div class="theme-assist-info">
                    ...
                    <span class="theme-assist-label"><?php echo esc_html__('More ', 'magazinemax') . esc_html($this->label) . esc_html__(' Available on Premium Version.', 'magazinemax'); ?></span>
                </div>
            </span>
