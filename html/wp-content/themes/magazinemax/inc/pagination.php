...
if (!function_exists('magazinemax_ajax_pagination')) :
    /**
     ...
     * @since 1.0.0
     */
    function magazinemax_ajax_pagination($type)
    {
        global $wp_query;
        if ($wp_query->max_num_pages > 1) {

            ?>
            <div class="magazinemax-load-posts-btn-wrapper" data-page="1"
                ...
                <a href="#" class="ajax-viewmore-link">
                    <span class="magazinemax-ajax-loader"></span>
                    <button class="load-btn"><?php _e('Load More', 'magazinemax') ?></button>
                </a>
            </div>
            <?php
        }
...
if (!function_exists('magazinemax_load_posts')) :
    /**
     ...
     *
     */
    function magazinemax_load_posts()
    {

        check_ajax_referer('magazinemax-load-posts-nonce', 'nonce');
        ...
        if ($posts->have_posts()):
            ...
            $error = new WP_Error('500', __('No More Posts', 'magazinemax'));
...
add_action('wp_ajax_magazinemax_load_posts', 'magazinemax_load_posts');
add_action('wp_ajax_nopriv_magazinemax_load_posts', 'magazinemax_load_posts');