 ...
 * @extends  WP_Widget
 */
abstract class Magazinemax_Widget_Base extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        $this->attrs = apply_filters(
            'magazinemax_widget_base_attr_arr',
            array(
                'type' => 'text',
                'class' => '',
                'wrapper_class' => '',
        ...
        add_action('admin_enqueue_scripts', array($this, 'magazinemax_widget_scripts'));
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        foreach ($this->settings as $key => $setting) {
             ...
             */
            $instance[$key] = apply_filters('magazinemax_widget_settings_sanitize', $instance[$key], $new_instance, $key, $setting);
        }
        ...
        foreach ($this->settings as $key => $setting) {
            ...
            switch ($setting['type']) {
                                ...
                                <?php foreach ($attr['options'] as $k => $v) : ?>
                                    <label for="<?php echo esc_attr($this->get_field_id($key) . '-' . $k); ?>">
                                        <input type="radio" name="<?php echo esc_attr($this->get_field_name($key)); ?>"
                                               ...
                                               value="<?php echo esc_attr($k); ?>" <?php checked($k, $value); ?> <?php echo (true === $attr['readonly']) ? ' disabled="disabled"  ' : ''; ?>/>
                                        <?php echo esc_html($v); ?>
                                    </label>&nbsp;&nbsp;
                                <?php endforeach; ?>
                            <?php endif ?>
                            ...
                            <div class="image-field">
                                ...
                                <p>
                                    ...
                                    <button type="button" class="upload_image_button button"
                                            data-uploader-title-txt="<?php esc_attr_e('Use Image', 'magazinemax'); ?>"
                                            data-uploader-btn-txt="<?php esc_attr_e('Choose an Image', 'magazinemax'); ?>">
                                        <?php esc_html_e('Upload/Add image', 'magazinemax'); ?>
                                    </button>
                                    <button type="button" class="remove_image_button button"
                                            style="<?php echo esc_attr($remove_button_style); ?>"><?php esc_html_e('Remove image', 'magazinemax'); ?></button>
                                </p>
                            </div>
                        </div>
                        <?php
                ...
                case 'heading':
                    ...
                    ?>
                    <div class="<?php echo esc_attr($attr['wrapper_class']); ?>">
                        <h4 class="widefat <?php echo esc_attr($attr['class']); ?>"
                ...
                case 'subtitle':
                    ...
                    ?>
                    <div class="<?php echo esc_attr($attr['wrapper_class']); ?>">
                        <span class="widefat <?php echo esc_attr($attr['class']); ?>"
                              style="<?php echo esc_attr($css); ?>">
                ...
                case 'message':
                    ...
                    ?>
                    <div class="<?php echo esc_attr($attr['wrapper_class']); ?>">
                        <div class="widefat field-message uf-custom-field-message <?php echo esc_attr($attr['class']); ?>"
                             style="<?php echo esc_attr($css); ?>">
                ...
                default:
                    do_action('magazinemax_widget_field_' . $setting['type'], $key, $value, $setting, $instance);
                    break;
            }
        }
    }
     ...
     * @return void
     */
    public function magazinemax_widget_scripts($hook)
    {
        ...
        if ('widgets.php' === $hook) {
            ...
            wp_enqueue_style('magazinemax_widgets_css', get_template_directory_uri() . '/inc/widgets/widget-base/css/style.css');
        }
        wp_enqueue_script('magazinemax_widgets_js', get_template_directory_uri() . '/inc/widgets/widget-base/js/script.js', array('jquery', 'wp-color-picker'), '1.0.0', true);
