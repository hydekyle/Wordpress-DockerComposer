...
function magazinemax_admin_setup()
{

    /**
     * Load and initialize Magazinemax Dashboard Notices
     *
     */
...
add_action('after_setup_theme', 'magazinemax_admin_setup');
