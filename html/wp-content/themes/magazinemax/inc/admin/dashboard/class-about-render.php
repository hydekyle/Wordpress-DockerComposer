 ...
 */
class Magazinemax_Theme_Dashboard
{
    ...
    public $settings = array(
        'tabs' => array(),
        'demo_link' => 'https://live-demo.themeinwp.net/magazinemax',
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_magazinemax_dismissed_handler', array($this, 'dismissed_handler'));
        ...
        if (isset($_GET['page']) && $_GET['page'] == 'theme-dashboard') {
            ...
            add_action('in_admin_header', array($this, 'magazinemax_hide_all_admin_notice'), 1000);

        }
    }


    public function magazinemax_hide_all_admin_notice()
    {
    ...
    {
        add_submenu_page('themes.php', esc_html__('Magazinemax Dashboard', 'magazinemax'), esc_html__('Theme Dashboard', 'magazinemax'), 'manage_options', $this->menu_slug, array($this, 'html_carcase'), 1);
    }
    ...
    {
        wp_enqueue_script('magazinemax', get_template_directory_uri() . '/inc/admin/dashboard/js/scripts.js', array('jquery'), filemtime(get_template_directory() . '/inc/admin/dashboard/js/scripts.js'), true);

        wp_localize_script('magazinemax', 'magazinemax_localize', array(
            'ajax_url' => admin_url('admin-ajax.php'),
            'nonce' => wp_create_nonce('nonce'),
            'upload_image' => esc_html__('Choose Image', 'magazinemax'),
            'use_image' => esc_html__('Select', 'magazinemax'),
            'active' => esc_html__('Active', 'magazinemax'),
            'deactivate' => esc_html__('Deactivate', 'magazinemax'),
            'failed_message' => esc_html__('Something went wrong, contact support.', 'magazinemax'),
        ));

        // Styles.
        wp_enqueue_style('magazinemax', get_template_directory_uri() . '/inc/admin/dashboard/css/style.css', array(), filemtime(get_template_directory() . '/inc/admin/dashboard/css/style.css'));

        // Add RTL support.
        wp_style_add_data('magazinemax', 'rtl', 'replace');
    }
                ...
                <div class="dashboard-feature-item <?php echo esc_attr($feature_status); ?>">
                    ...
                    <div class="dashboard-feature-row dashboard-feature-row-bottom">
                        ...
                        if (isset($feature['activate_uri']) && $feature['activate_uri']) {
                            ...
                            ?>
                            <?php if (!Magazinemax_Modules::is_module_active($feature['slug'])) : ?>
                                <a href="<?php echo esc_attr($activate_uri); ?>=1"
                                   class="dashboard-feature-item-customize">
                                    <?php esc_html_e('Activate', 'magazinemax'); ?>
                                </a>
                            <?php else : ?>
                                <a href="<?php echo esc_attr($activate_uri); ?>=0"
                                   class="dashboard-feature-item-customize">
                                    <?php esc_html_e('Deactivate', 'magazinemax'); ?>
                                </a>
                                <?php if ($feature['link']) : ?>
                            ...
                            <a href="<?php echo esc_attr($customize_uri); ?>" class="dashboard-feature-item-customize"
                               target="_blank">
                                <?php esc_html_e('Customize', 'magazinemax'); ?>
                            </a>
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="suggested-enhancement">
                ...
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Fastest WordPress Hosts', 'magazinemax'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('A slow host can really put a drag on your site’s performance, even an optimized one. Make sure you get a host that won’t hold you back by reading our review, complete with real speed tests, of the fastest WordPress hosts. ', 'magazinemax'); ?>
                        </div>

                        <a class="suggested-enhancement-link"
                           href="<?php echo esc_url($this->settings['insights_link_1']); ?>" target="_blank">
                            <?php esc_html_e('Read more', 'magazinemax'); ?>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('WP Rocket Review', 'magazinemax'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('Every site that is serious about speed (and should be pretty much all sites these days) needs a caching plugin and WP Rocket is our pick of the bunch. Get the lowdown on why we recommend it n our data-backed review: ', 'magazinemax'); ?>
                        </div>

                        <a class="suggested-enhancement-link"
                           href="<?php echo esc_url($this->settings['insights_link_2']); ?>" target="_blank">
                            <?php esc_html_e('Read more', 'magazinemax'); ?>
                        </a>
                    </div>
                </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Best WordPress Speed Optimization Plugins', 'magazinemax'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('We run through the top 10 WordPress performance plugins to keep your site running fast. Goes beyond just caching plugins (though those are on there too!). A must-read for all WordPress site owners.', 'magazinemax'); ?>
                        </div>

                        <a class="suggested-enhancement-link"
                           href="<?php echo esc_url($this->settings['insights_link_3']); ?>" target="_blank">
                            <?php esc_html_e('Read more', 'magazinemax'); ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="dashboard-hero-panel">
            <div class="hero-panel-content">
                <div class="hero-panel-subtitle">
                    <?php esc_html_e('Hello, ', 'magazinemax'); ?>
                ...
                <div class="theme-admin-button-wrap theme-admin-button-group">
                    ...
                    <?php if ('themes.php' === $pagenow && 'themes' === $screen->base) { ?>
                        <a href="<?php echo esc_url(add_query_arg('page', $this->menu_slug, admin_url('themes.php'))); ?>"
                           class="button theme-admin-button admin-button-primary">
                            <span class="dashicons dashicons-dashboard"></span>
                            <span><?php esc_html_e('Theme Dashboard', 'magazinemax'); ?></span>
                        </a>
                    <?php } ?>

                    <a href="<?php echo esc_url($this->settings['demo_link']); ?>"
                       class="button theme-admin-button admin-button-secondary" target="_blank">
                        <span class="dashicons dashicons-welcome-view-site"></span>
                        <span><?php esc_html_e('View Live Demo', 'magazinemax'); ?></span>
                    </a>

                    <a href="<?php echo esc_url($this->settings['documentation_link']); ?>"
                       class="button theme-admin-button admin-button-secondary" target="_blank">
                        <span class="dashicons dashicons-media-document"></span>
                        <span><?php esc_html_e('Theme Documentation', 'magazinemax'); ?></span>
                    </a>
                </div>
                ...
                <div class="dashboard-wrapper">
                    <div class="dashboard-header-panel">
                        <div class="dashboard-masthead-item dashboard-masthead-left">
                            <a href="<?php echo esc_url('https://themeinwp.com/'); ?>" class="theme-author-logo"
                               target="_blank">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/dashboard/images/magazinemax-logo.png'); ?>"
                                     alt="<?php esc_attr_e('ThemeinWP', 'magazinemax'); ?>">
                            </a>
                        </div>

                        <div class="dashboard-masthead-item dashboard-masthead-right">
                            <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-button-small theme-admin-button admin-button-tertairy" target="_blank">
                                <span class="dashicons dashicons-media-document"></span>
                                <span><?php esc_html_e('Documentation', 'magazinemax'); ?></span>
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        foreach ($this->settings['tabs'] as $tab) {
                                            ...
                                            <div class="dashboard-panel-tab <?php echo esc_attr(1 === $counter ? 'dashboard-panel-tab-active' : null); ?>">
                                                <h3 class="dashboard-panel-title">
                                                    ...
                                                    <a href="#tab-content-<?php echo substr($tab['name'], 0, 5); ?>"><?php echo esc_html($tab['name']); ?></a>
                                                </h3>
                                            </div>
                                        <?php } ?>
                                    </div>
                        ...
                        <div class="dashboard-hero-main-sidebar">
                                ...
                                <div class="theme-dashboard-panel dashboard-panel-promo">
                                    <div class="dashboard-panel-inner">
                                        ...
                                        <div class="theme-admin-button-wrap">
                                            <a href="<?php echo esc_url($this->settings['promo_link']); ?>"
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-review">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title"><?php esc_html_e('Review', 'magazinemax'); ?></h3>
                                </div>
                                <div class="dashboard-panel-content">
                                    ...
                                    <div class="theme-admin-description"><?php esc_html_e('It makes us happy to hear from our users. We would appreciate a review.', 'magazinemax'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['review_link']); ?>"
                                           class="theme-admin-button button" target="_blank">
                                            <?php esc_html_e('Submit a Review', 'magazinemax'); ?>
                                        </a>
                                    </div>

                                    <div class="theme-admin-separator"></div>

                                    <div class="theme-admin-title"><?php esc_html_e('Have an idea or feedback?', 'magazinemax'); ?></div>

                                    <div class="theme-admin-description">
                                        <?php esc_html_e('If you have any suggestions or comments about our WordPress theme, please let us know. We value your feedback and strive to continuously improve our product.', 'magazinemax'); ?>
                                    </div>

                                    <a href="<?php echo esc_url($this->settings['suggest_idea_link']); ?>"
                                       class="theme-feature-request" target="_blank">
                                        <?php esc_html_e('Suggest an Idea', 'magazinemax'); ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-changelog">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title">
                                        <?php esc_html_e('Changelog', 'magazinemax'); ?>
                                    </h3>
                                ...
                                <div class="dashboard-panel-content">
                                    <div class="theme-admin-description"><?php esc_html_e('The theme changelog provides a brief history of updates and modifications made to the theme. Keep informed with the changes and improvements that have been made over time.', 'magazinemax'); ?></div>

                                    <a href="<?php echo esc_url($this->settings['changelog_link']); ?>"
                                       class="theme-changelog-info" target="_blank">
                                        <?php esc_html_e('See the Changelog', 'magazinemax'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="dashboard-wrapper">
                    <div class="dashboard-footer-panel">
                        <div class="theme-dashboard-panel dashboard-panel-support">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Support', 'magazinemax'); ?></h3>

                                <?php if ($this->pro_status) { ?>
                                    <div class="theme-dashboard-badge theme-badge-primary"><?php esc_html_e('Priority Status', 'magazinemax'); ?></div>
                                <?php } ?>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-dashboard-subpanel">
                                    <div class="theme-admin-title">
                                        <?php echo wp_kses_post(__('Need help? We\'re here for you!', 'magazinemax')); ?>
                                    </div>

                                    <div class="theme-admin-description"><?php esc_html_e('Do you have a question or have you encountered a bug? You can receive assistance from our amicable support team whenever you require it.', 'magazinemax'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['support_link']); ?>"
                                           class="button theme-admin-button admin-button-secondary" target="_blank">
                                            <?php esc_html_e('Get Support', 'magazinemax'); ?>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <?php if (!$this->pro_status) { ?>
                                    <div class="theme-dashboard-subpanel dashboard-subpanel-bg">
                                        <div class="theme-admin-title">
                                            <?php echo wp_kses_post(__('Upgrade to priority support', 'magazinemax')); ?>

                                            <div class="theme-dashboard-badge theme-badge-secondary"><?php esc_html_e('pro', 'magazinemax'); ?></div>
                                        </div>

                                        <div class="theme-admin-description">
                                            <?php esc_html_e('Receive support via email with a prompt initial response time of 1-2 hours for all priority requests.', 'magazinemax'); ?>
                                        </div>

                                        <div class="theme-admin-button-wrap">
                                            <a href="<?php echo esc_url($this->settings['support_pro_link']); ?>"
                                               class="button theme-admin-button admin-button-primary" target="_blank">
                                                <?php esc_html_e('Get Priority Support', 'magazinemax'); ?>
                                            </a>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="theme-dashboard-panel dashboard-panel-community">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Community', 'magazinemax'); ?></h3>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-admin-title">
                                    <?php echo wp_kses_post(__('Join Our Community', 'magazinemax')); ?>
                                </div>

                                <div class="theme-admin-description"><?php esc_html_e('Engage with the community: talk about products, ask for help or offer assistance to the community.', 'magazinemax'); ?></div>

                                <div class="theme-admin-button-wrap">
                                    <a href="<?php echo esc_url($this->settings['community_link']); ?>"
                                       class="button theme-admin-button admin-button-tertairy" target="_blank">
                                        <?php esc_html_e('Join Now', 'magazinemax'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    public function notice()
    {
        ...
        if ('themes.php' === $pagenow) {
            ...
            if (!get_transient($transient_name)) {
                ...
                ?>
                <div class="notice notice-success magazinemax-primary-notice theme-admin-dashboard theme-admin-dashboard-notice is-dismissible"
                     data-notice="<?php echo esc_attr($transient_name); ?>">
    ...
    public function notice_enqueue_scripts($page)
    {
        ...
        <script>
            jQuery(function ($) {
                $(document).on('click', '.magazinemax-primary-notice .notice-dismiss', function () {
                    jQuery.post('ajax_url', {
                        action: 'magazinemax_dismissed_handler',
                        notice: $(this).closest('.magazinemax-primary-notice').data('notice'),
                    });
...
new Magazinemax_Theme_Dashboard();
